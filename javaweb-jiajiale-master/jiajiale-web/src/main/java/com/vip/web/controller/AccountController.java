...
public class AccountController {
    ...
    @PostMapping("/session")
    public JSONResponse login(String account, String password, HttpSession session) throws Exception {
    ...
    public  JSONResponse modifyPassword( String id,String name)throws Exception{
        accountService.modifyName(id, name);
        return JSONResponse.ok();
    }
